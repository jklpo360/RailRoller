...
func _input(event):
	...
	if event is InputEventKey and event.pressed and event.physical_keycode == KEY_4:
		choose_destination(3)
	if event is InputEventKey and event.pressed and event.physical_keycode == KEY_5:
		choose_destination(4)
	if event is InputEventKey and event.pressed and event.physical_keycode == KEY_6:
